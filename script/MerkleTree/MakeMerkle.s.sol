...
/**
 * @title MakeMerkle Script Contract
 * @author anurag shingare
 
 * @notice This script is used to generate the output file(Merkle Tree) containing hashes!!!
 * @notice Output file will contains merkle root hash ,siblings proof hash and leaf node hash
